...
#ifndef HOME_ZERO_ROM_ZERO2NP_SRC_GRAPHICS_MOTION_ANICODE_H
#define HOME_ZERO_ROM_ZERO2NP_SRC_GRAPHICS_MOTION_ANICODE_H
...
#endif // HOME_ZERO_ROM_ZERO2NP_SRC_GRAPHICS_MOTION_ANICODE_H
