...
INCLUDE_ASM("asm/nonmatchings/main/main", newAssert__FPc);

INCLUDE_ASM("asm/nonmatchings/main/main", init_super__Fv);

INCLUDE_ASM("asm/nonmatchings/main/main", end_super__Fv);

INCLUDE_ASM("asm/nonmatchings/main/main", pre_super__F11GPHASE_ENUM);

INCLUDE_ASM("asm/nonmatchings/main/main", after_super__F11GPHASE_ENUM);

INCLUDE_ASM("asm/nonmatchings/main/main", init_Boot_Init__Fv);

INCLUDE_ASM("asm/nonmatchings/main/main", end_Boot_Init__Fv);
...
INCLUDE_ASM("asm/nonmatchings/main/main", init_SoftResetMain__Fv);

INCLUDE_ASM("asm/nonmatchings/main/main", one_SoftResetMain__F11GPHASE_ENUM);

INCLUDE_ASM("asm/nonmatchings/main/main", end_SoftResetMain__Fv);
