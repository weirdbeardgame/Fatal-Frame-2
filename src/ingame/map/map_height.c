...
INCLUDE_ASM("asm/nonmatchings/ingame/map/map_height", MhInitMapHeight__FiPfi);

INCLUDE_ASM("asm/nonmatchings/ingame/map/map_height", MhGetMapHeight__FPfT0ii);

INCLUDE_ASM("asm/nonmatchings/ingame/map/map_height", MhDrawHeight__Fi);
