...
struct old_exception_table { // 0xc
	/* 0x0 */ void *start_region;
	/* 0x4 */ void *end_region;
	/* 0x8 */ void *exception_handler;
};

struct exception_table { // 0x10
	/* 0x0 */ void *start_region;
	/* 0x4 */ void *end_region;
	/* 0x8 */ void *exception_handler;
	/* 0xc */ void *match_info;
...
struct exception_lang_info { // 0x4
	/* 0x0 */ short int language;
	/* 0x2 */ short int version;
};

struct exception_descriptor { // 0x18
...
struct fde_vector { // 0x8
	/* 0x0 */ fde **array;
	/* 0x4 */ size_t count;
};

struct fde_accumulator { // 0x10
