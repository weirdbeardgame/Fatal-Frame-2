...
### Health:
<p>
Character's that are living in the battle sytem, IE. contain stats like health. This goes for all enemies as well as Mio and Mayu. Max Health and Health representing the current health change based on the game's difficulty mode for Mio and Mayu.
</p>
<details>
...
```cpp
  ...
  /// Note that there's 4 difficulties 3 being the hardest
